...
module.exports = {
  ...
  _defaultMessage: {
    ...
    "uz-LATN": '"{{=e.keyword}}" kalitsoʻz qoidasidan oʻtishi kerak',
  ...
  _type: {
    ...
    "uz-LATN": "{{#def.t}} {{=t+n}} boʻlishi kerak",
    zh: "{{#def.t}}应当是 {{=t+n}} 类型",
  ...
  properties: {
    ...
    additional: {
      ...
      "uz-LATN": "qoʻshimcha maydonlar boʻlmasligi kerak",
      zh: "不允许有额外的属性",
      "zh-TW": "不可以有額外的屬性",
    },
    missing: {
      ...
      "uz-LATN": "{{=e.params.missingProperty}} zaruriy maydonga ega boʻlishi kerak",
  ...
  discriminator: {
    ...
    tag: {
      ...
      "uz-LATN": '"{{=e.params.tag}}" teg satr boʻlishi kerak',
    ...
    mapping: {
      ...
      "uz-LATN": '"{{=e.params.tag}}" teg sxemalardan biridagi kalit boʻlishi kerak',
  ...
  union: {
    ...
    "uz-LATN": '"union" dagi sxemalardan biriga mos kelishi kerak',
