...
module.exports = {
  ...
  _defaultMessage: {
    ...
    "uz-LATN": '"{{=e.keyword}}" qoidaga mos kelishi kerak',
  ...
  "false schema": {
    ...
    "uz-LATN": "boolean sxema qiymati false",
    zh: "布尔模式出错",
    "zh-TW": "布林模式不正確",
  },
  additionalItems: {
  ...
  additionalProperties: {
    ...
    "uz-LATN": "qoʻshimcha maydonlarga ega boʻlmaslik kerak",
    zh: "不允许有额外的属性",
    "zh-TW": "不可以有額外的屬性",
  },
  anyOf: {
    ...
    "uz-LATN": '"anyOf" sxemalaridan biri boʻlishi kerak',
  ...
  enum: {
    ...
    "uz-LATN": "mumkin boʻlgan qiymatlardan biriga teng boʻlishi kerak",
    zh: "应当是预设定的枚举值之一",
    "zh-TW": "應該要在預設的值之中",
  },
  format: {
    ...
    "uz-LATN": '"{{=e.params.format}}" formatga mos kelishi kerak',
  ...
  maximum: {
    ...
    th: "{{#def.c}}ต้อง {{=cond}}",
    "uz-LATN": "{{#def.c}} {{=cond}} boʻlishi kerak",
    zh: "{{#def.c}}应当为 {{=cond}}",
  ...
  maxLength: {
    ...
    "uz-LATN": "{{#def.n}} {{=n}}dan koʻp boʻlmagan belgi{{#def.mPlural}}",
    zh: "{{#def.n}}不应多于 {{=n}} 个字符",
  ...
  minLength: {
    ...
    "uz-LATN": "{{#def.n}}, {{=n}}dan kam boʻlmagab belgi{{#def.mPlural}} iborat boʻlishi kerak",
    zh: "{{#def.n}}不应少于 {{=n}} 个字符",
  ...
  minProperties: {
    ...
    "uz-LATN": "{{#def.n}}, {{=n}}dan kam boʻlmagan maydon{{#def.propPlural}} boʻlishi kerak",
  ...
  multipleOf: {
    ...
    "uz-LATN": "{{=e.params.multipleOf}} karrali boʻlishi kerak",
  ...
  not: {
    ...
    "uz-LATN": '"not" sxemasiga mos boʻlmasligi kerak',
    zh: '不应当匹配 "not" schema',
  ...
  oneOf: {
    ...
    "uz-LATN": '"oneOf" sxemalaridan birontasiga aniq mos kelishi kerak',
  ...
  pattern: {
    ...
    "uz-LATN": '"{{=e.params.pattern}}" andozaga mos kelishi kerak',
  ...
  required: {
    ...
    "uz-LATN": "{{=e.params.missingProperty}} majburiy maydonga ega boʻlishi kerak",
  ...
  type: {
    ...
    "uz-LATN": "{{=e.params.type}} boʻlishi kerak",
  ...
  unevaluatedProperties: {
    ...
    "uz-LATN": "tekshirilmagan maydonlarga ega boʻlmaslik kerak",
    zh: "不允许存在未求值的属性",
    "zh-TW": "不應該有未驗證的屬性",
  },
  unevaluatedItems: {
  ...
  propertyNames: {
    ...
    "uz-LATN": "maydon nomi sxemaga mos emas",
    zh: "属性名 无效",
    "zh-TW": "属性名 無效",
  },
  patternRequired: {
    ...
    "uz-LATN": '"{{=e.params.missingPattern}}" andozaga mos maydonga ega boʻlishi kerak',
  ...
  const: {
    ...
    "uz-LATN": "berilgan qiymatga mos boʻlishi kerak",
    zh: "应当等于常量",
    "zh-TW": "應該等於常數",
  },
  contains: {
    ...
    "uz-LATN": "tarkibida sxemadagi qiymat boʻlishi kerak",
    zh: "应当包含一个有效项",
    "zh-TW": "應該包含一個有效元素",
  },
  formatMaximum: {
  ...
  discriminator: {
    ...
    tag: {
      ...
      "uz-LATN": '"{{=e.params.tag}}" maydoon satr boʻlishi kerak',
    ...
    mapping: {
      ...
      "uz-LATN": '"{{=e.params.tag}}" maydon qiymati oneOf sxemalaridan biri boʻlishi kerak',
